<div class="iconSelector modal">
    <input type="hidden" name="feed-id" value="" />
    <h2 class="title">Select icon</h2>
    <div class="iconlist">
        ...
        <span class="fa fa-thermometer-0"></span>
        <span class="fa fa-thermometer-1"></span>
        <span class="fa fa-thermometer-2"></span>
        <span class="fa fa-thermometer-3"></span>
        <span class="fa fa-thermometer-4"></span>
        ...
        <span class="fa fa-times-rectangle-o"></span>
    ...
    <button class="">Don't use icon</button>
</div>
